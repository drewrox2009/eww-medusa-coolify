    ...
    <div className="space-y-0">
      ...
      <section className="hero-surface section-padding pb-10 lg:pb-12">
        <div className="container-custom grid gap-16 lg:grid-cols-[1.1fr_minmax(0,0.9fr)] lg:items-center">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-xl text-lg text-gray-600">
                Octochems combines regulated pharmaceutical sourcing with
            ...
            <ul className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                >
                  <span className="mt-1 inline-flex rounded-full bg-gray-100 p-1 text-black">
          ...
          <div className="relative">
            <div className="card-surface relative overflow-hidden rounded-[32px] border-gray-200 bg-white/80 p-6">
            ...
            <div className="card-surface absolute -bottom-10 left-1/2 flex -translate-x-1/2 gap-6 whitespace-nowrap rounded-full border-gray-200 bg-white/90 px-6 py-4 text-sm text-gray-600 shadow-ambient lg:px-8">
              {heroStats.map((stat) => (
            ...
            {trustIndicators.map((item) => {
              ...
              return (
                <div key={item.title} className="card-surface h-full p-6">
                  <span className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-gray-100 text-black">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom space-y-14">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <Link
              href="/register"
              className="inline-flex items-center justify-center rounded-full border border-gray-200 bg-white px-5 py-3 text-sm font-semibold text-black transition hover:border-primary-300 hover:bg-primary-50"
            >
              Create an account
            </Link>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative space-y-4">
                    <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gray-100 text-black">
                      <Icon className="h-5 w-5" />
                    </span>
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {categories.map((category) => (
              <Link
                key={category.name}
                href={category.href}
                className="group relative overflow-hidden rounded-lg border border-gray-200 bg-gradient-to-br p-8 shadow-subtle transition hover:border-gray-200 hover:shadow-ambient"
              ...
              >
                ...
                <div className="relative space-y-5">
                  <div className="inline-flex rounded-full bg-white/70 px-4 py-1 text-xs font-semibold text-black">
                    {category.name}
                  </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="card-surface overflow-hidden rounded-[32px] border border-gray-200 bg-white p-10 text-black shadow-ambient lg:p-14">
